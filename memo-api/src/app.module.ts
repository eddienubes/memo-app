...
import {
  elasticConfig,
  elasticConfigSchema,
} from './common/config/elastic-config';
import { SearchModule } from './search/search.module';
import {
  emailManagerConfig,
  emailManagerValidationSchema,
} from './email-manager/config/email-manager-config';
import { EmailManagerModule } from './email-manager/email-manager.module';
import {
  googleAuthConfig,
  googleAuthValidationSchema,
} from './common/config/google-auth-config';
import {
  redisConfig,
